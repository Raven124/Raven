...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] menus = {"Регистрация", "Навигация", "Профиль", "Мастер",
                "Активность", "Галерея", "Коммерция", "Дополнительно", "Плеер",
                "Новости", "Наполнители"};
